...
def fileopener(filename_):
    ...
    fieldnames = ['AppID_A','AppID_B','Functional_similarity', 'Rating_B', 'Downloads_B']
...
if __name__ == '__main__':
    ...
    dir_name='C:\\Users\\mdkafiluddin\\Desktop\\Research\\Dataset\\GooglePlay2020\\Communication\\comm_top_free\\cross_domain'
    with open('C:\\Users\\mdkafiluddin\\Desktop\\Research\\Dataset\\GooglePlay2020\\Communication\\comm_top_free\\app_desc.csv', encoding='utf-8',errors='ignore') as f_a:
        filename= dir_name+'\\'+'comm_productivity'+'.csv'
        csv_writer=fileopener(filename)
        f_csv_a = csv.DictReader(f_a)
        for line_a in f_csv_a:
            app_id=line_a['AppID']
            ...
            with open('C:\\Users\\mdkafiluddin\\Desktop\\Research\\Dataset\\GooglePlay2020\\Productivity\\productivity_top_free\\app_desc.csv', encoding='utf-8',errors='ignore') as f_b:
                ...
                for line_b in f_csv_b:
                    ...
                    app_simi_score=w2v(app_desc_x,app_desc_y,wordmodel)
                    print("sim(description_1,description_2) = ", app_simi_score,"/1.")
                    csv_writer.writerow({'AppID_A':line_b['AppID'],'AppID_B':line_b['AppID'],'Functional_similarity':app_simi_score,'Rating_B':line_b['AppRating'], 'Downloads_B':line_b['MinInstalls']})


    dir_name='C:\\Users\\mdkafiluddin\\Desktop\\Research\\Dataset\\GooglePlay2020\\Communication\\comm_top_free\\cross_domain'
    with open('C:\\Users\\mdkafiluddin\\Desktop\\Research\\Dataset\\GooglePlay2020\\Communication\\comm_top_free\\app_desc.csv', encoding='utf-8',errors='ignore') as f_a:
        filename= dir_name+'\\'+'comm_lifestyle'+'.csv'
        csv_writer=fileopener(filename)
        f_csv_a = csv.DictReader(f_a)
        for line_a in f_csv_a:
            app_id=line_a['AppID']
    ...
    dir_name='C:\\Users\\mdkafiluddin\\Desktop\\Research\\Dataset\\GooglePlay2020\\Communication\\comm_top_free\\cross_domain'
    with open('C:\\Users\\mdkafiluddin\\Desktop\\Research\\Dataset\\GooglePlay2020\\Communication\\comm_top_free\\app_desc.csv', encoding='utf-8',errors='ignore') as f_a:
        filename= dir_name+'\\'+'comm_books'+'.csv'
        csv_writer=fileopener(filename)
        f_csv_a = csv.DictReader(f_a)
        for line_a in f_csv_a:
            app_id=line_a['AppID']
